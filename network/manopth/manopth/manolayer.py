...
class ManoLayer(Module):
    ...
    def forward(self,
        ...
        if th_trans is None or bool(torch.norm(th_trans) == 0):
            ...
            root_trans[:,:3, -1] = root_trans[:,:3,-1] + th_trans.view(-1, 1, 3)

        # # Scale to milimeters
        # th_verts = th_verts * 1000
        # th_jtr = th_jtr * 1000
        #root_trans[:,:3, -1] = root_trans[:,:3,-1] * 1000
        
        return th_verts, th_jtr, th_full_pose,th_results_global,center_joint, root_trans
